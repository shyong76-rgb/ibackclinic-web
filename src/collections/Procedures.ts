...
export const Procedures: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'heroStatNumber', type: 'text', label: '큰 숫자 (예: 4)' },
    { name: 'heroStatCaption', type: 'text', label: '큰 숫자 옆 설명 (예: 네 단계를 순서대로 이어갑니다)' },
    { name: 'aboutHeadline', type: 'text', label: '소개 섹션 헤드라인 (ABOUT THE CARE)' },
    ...
    { name: 'photoNote', type: 'textarea', label: '전후사진 촬영 안내 (PHOTO NOTE)' },
    { name: 'productNote', type: 'textarea', label: '제품/기기 설명 (PRODUCT & DEVICE)' },
    {
      name: 'composition',
      type: 'array',
